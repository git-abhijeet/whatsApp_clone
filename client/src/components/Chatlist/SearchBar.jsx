  ...
  return (
    <div className="flex items-center gap-3 py-3 pl-5 bg-search-input-container-background h-14">
      <div className="flex items-center flex-grow gap-5 px-3 py-1 rounded-lg bg-panel-header-background">
        ...
        <div>
          <input type="text" value={contactSearch} onChange={(e) => dispatch({ type: reducerCases.SET_CONTACT_SEARCH, contactSearch: e.target.value })} placeholder="Search or start a new chat" className="w-full text-sm text-white bg-transparent focus:outline-none" />
        </div>
      </div>
